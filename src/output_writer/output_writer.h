...
public:
  ...
  OutputWriter(shared_ptr<Discretization> discretization, Settings settings);
...
protected:
  ...
  Settings settings_;  //< a shared pointer to the discretization which contains all data that will be written to the file
