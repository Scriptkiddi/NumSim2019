...
public:
  ...
  OutputWriter(std::shared_ptr<StaggeredGrid> staggeredGrid);
...
protected:
  ...
  std::shared_ptr<StaggeredGrid> staggeredGrid_;  //< a shared pointer to the discretization which contains all data that will be written to the file
